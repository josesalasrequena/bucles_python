...
for temperatura in temp_dataloger:
    ...
    temperatura_sumatoria = temperatura_sumatoria + temperatura
    temperatura_len = temperatura_len + 1 
    temperatura_promedio = temperatura_sumatoria / temperatura_len
print("Máximo Temperatura = ", temperatura_max)
print("Minima Temperatura = ", temperatura_min)
print("Existen ", temperatura_len, "temperaturas en la lista")
print("Promedio de Temperatura = ", temperatura_promedio)
...
print ('Sumatoria de Temperatura:', sum(temp_dataloger))
'''
...
if (temperatura_max <= 20) and (temperatura_min >= 11):
    print('Estamos en Otoño')  
if (temperatura_max <= 14) and (temperatura_min >= 8):
    print('Estamos en Invierno')
if (temperatura_max <= 24) and (temperatura_min >= 10):
